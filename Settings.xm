...
%new - (void)updateCercubePlusSectionWithEntry:(id)entry {
    ...
    NSMutableArray <YTSettingsSectionItem *> *sectionItems = [NSMutableArray arrayWithArray:@[autoFull, hideCercubeButton, hideCercubePiP, hideCercubeDownload, hideCastButton, ytMiniPlayer, hideAutoplaySwitch, hideCC, hideHUD, hoverCardItem, hideWatermarks, bigYTMiniPlayer, oledKeyBoard, oledDarkMode,reExplore]];
